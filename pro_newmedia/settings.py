...
DATABASES = {
    "default": {
        ...
        "NAME": config("MYSQL_DATABASE", default="newmedia_db"),
        "USER": config("MYSQL_USER", default="newmedia"),
        "PASSWORD": config("MYSQL_PASSWORD", default="newmediapass"),
...
Q_CLUSTER = {
    ...
    'cpu_affinity': 1,
    'label': 'Django Q',
    'redis': config('REDIS_URL', default=config('REDIS_PRIVATE_URL', default=config('REDIS_PUBLIC_URL', default='redis://localhost:6379')))
}
