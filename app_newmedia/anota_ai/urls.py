...
urlpatterns = [
    ...
    path('criar/', views.anotacao_form, name='anotacao_criar'),
    path('<int:pk>/', views.anotacao_detalhes, name='anotacao_detalhes'),
    path('<int:pk>/form/', views.anotacao_form, name='anotacao_form'),
    path('<int:pk>/ticar/', views.anotacao_ticar, name='anotacao_ticar'),
    path('<int:pk>/salvar-itens/', views.anotacao_salvar_itens, name='anotacao_salvar_itens'),
